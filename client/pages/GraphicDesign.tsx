...
export default function GraphicDesign() {
  ...
  const projects = [
    {
      image: "/Portfolio/images/RDA Butterfly.png",
      title: "RDA Butterfly",
      description:
    ...
    {
      image: "/Portfolio/images/Anderson Brand.png",
    ...
    {
      image: "/Portfolio/images/ActivePeak 1.0.png",
    ...
    {
      image: "/Portfolio/images/IWetMyPlants.jpg",
    ...
    {
      image: "/Portfolio/images/ActivePeak Retro.jpg",
    ...
    {
      image: "/Portfolio/images/Hawkeyes.png",
      title: "Hawkeyes",
      description:
    ...
    {
      image: "/Portfolio/images/Iowa Podcast 1.0.png",
    ...
    {
      image: "/Portfolio/images/design center.png",
      title: "Design Center",
      description:
    ...
    {
      image: "/Portfolio/images/WOLVES-100.jpg",
      title: "Wolves",
    ...
    {
      image: "/Portfolio/images/VALR.png",
    ...
    {
      image: "/Portfolio/images/Orion.png",
      title: "Orion",
    ...
    <div className="min-h-screen bg-[#111117] text-white">
      ...
      <main className={`px-4 pb-16 ${viewMode === "mobile" ? "block" : viewMode === "desktop" ? "hidden" : "md:hidden"}`}>
        ...
        <Link to="/" className="block mb-6 rounded-2xl overflow-hidden shadow-[2px_4px_4px_0_rgba(0,0,0,0.57)]">
          <img
            src="/Portfolio/images/o design 1.png"
            alt="Graphic Design"
